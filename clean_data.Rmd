...
write.csv(enroll.clean, "Data/CLEAN_enrollment.csv")
```
...
# write clean data to csv
write.csv(math.pisa.clean, "Data/CLEAN_pisa_math.csv")
```
...
# write clean data to csv
write.csv(sci.pisa.clean, "Data/CLEAN_pisa_science.csv")
```
...
write.csv("country.codes", "Data/country_codes.csv")
```
...
write.csv(grads.clean, "Data/CLEAN_2017_grads_field.csv")
```
...
write.csv(earn.deg.clean, "Data/CLEAN_earnings_degree.csv")
```
...
write.csv(earn.numeracy.clean, "Data/CLEAN_earnings_numeracy.csv")
```